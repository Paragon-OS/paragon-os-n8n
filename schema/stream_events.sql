-- Stream Events Table Schema
-- This table stores all stream monitor events from n8n workflow executions
...
-- Optional: Create a composite index for common query patterns (execution_id + timestamp)
