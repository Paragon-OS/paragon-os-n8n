...
// NOTE: Local n8n testing functions (connectToLocalN8n, setupTestInstanceSmart, cleanupTestInstanceSmart)
// have been removed. All CLI commands now use pod-based connections via getRunningPodConnection().
// Tests should use setupTestInstance() to create isolated test containers, or startMcpPod() for MCP-based tests.
